...
export class MedicalStateService {
   ...
   * records the interaction, and updates recent patients list.
   * 
   * @example
   * ```typescript
   * // Set active patient
   ...
   * 
   * @description Performs patient search and updates search results.
   ...
   * 
   * @private
   * @description Fetches the most recent patients and updates the recent patients list
   */
